                        ...
                        <article className="relative pt-10">
                            ...
                            <div className="mt-12 mb-24 prose">
                                ...
                                <ul>
                                    ...
                                    <li><strong>Debugger</strong> Starknet currently lacks a debugger that allows developers to inspect variables and states during transaction execution. A debugger would make it easier for developers to reconstruct execution state without any modifications to the code and pinpoint errors effectively.</li>
                                </ul>
