                  ...
                  <main>
                    <article className="relative">
                      <div className="mt-12 mb-24 prose">
                        <p className="lead">If you&apos;ve ever looked at a Starknet transaction and wondered where all the gas goes — we’ve got the answer.
                        </p>
                        ...
                        <h2>
                          Example: analysing gas cost of a sample transaction
                        </h2>
                        <p>
                        ...
                        <figure>
                          ...
                          <figcaption>
                          🔎  Click each &quot;blue gas&quot; chip on the right to get quick access to a specific level of the Flamegraph.
                          </figcaption>
                        </figure>
                        <p>
                          You can see the transaction in the image above. It involves a few contract calls, each with its own gas cost visualised in the blue chip on the right:
                        </p>
                        <ul>
                          <li>
                            <span className="text-BLUE font-mono">AccountContract</span>.<span className="text-red-600 p-1 bg-GREY rounded-sm font-mono">__validate__</span>: 86,635
                          </li>
                          <li>
                            <span className="text-BLUE font-mono">AccountContract</span>.<span className="text-red-600 font-mono p-1 bg-GREY rounded-sm">__execute__</span>: 27,435,820
                          </li>
                          <li className="break-words">
                            <span className="text-BLUE font-mono">0x7b14d2b859efbbc97d68ca769d6e9b6a1c1fd9629d213e8555335448dc759bf</span>.
                            <span className="text-red-600 font-mono p-1 bg-GREY rounded-sm">test_call_contract</span>: 27,710,801
                          </li>
                          <li className="break-words">
                            <span className="text-BLUE font-mono">0x69b0b8db5469b82390505d02cda4ca08bebf50ca0d824a88b6756fcd5aaf5e5</span>.
                            <span className="text-red-600 font-mono p-1 bg-GREY rounded-sm">test_signature_verification_secp256r1</span>: 27,355,850
                          </li>
                          <li className="break-words">
                            <span className="text-BLUE font-mono">0x7b14d2b859efbbc97d68ca769d6e9b6a1c1fd9629d213e8555335448dc759bf</span>.
                            <span className="text-red-600 font-mono p-1 bg-GREY rounded-sm">test_poseidon_hades_permutation</span>: 6,131
                          </li>
                        </ul>
                        <div className={`lg:bg-GREY lg:p-2`}>
                          <div 
                        ...
                        <p>
                          ...
                          The root frame is the total L2 Gas of the transaction and it is divided into two main parts:
                        </p>


                        <ul>
                          <li>
                            <span className="font-bold">Computation resources:</span> actual Cairo (or more specifically Sierra) execution:
                          </li>
                          <ul>
                            <li>VM cost: Measures how many VM steps were executed together with the usage of builtins e.g. 
                            ...
                            <li>
                            Sierra cost: it tracks the logical structure and complexity of the code, summing the cost of each Sierra libfunc 
                        ...
                        <h3>Cheat Sheet for Optimizing Cairo Transactions Gas Usage</h3>
