...
export default function BeerForm() {
  ...
  const handleConnect = async () => {
    ...
    try {
      ...
      params.set('transactionHash', tx.transaction_hash)
      router.push(pathname + '?' + createQueryString('transactionHash', tx.transaction_hash))
		} catch (error: unknown) {
      ...
      <Container className="pb-16 pt-20 text-center lg:pt-32">
        <div className="max-w-2xl mx-auto">
          ...
          <div>
            ...
            <p className="mx-auto my-6 max-w-2xl text-lg tracking-tight text-slate-700 break-all">The transaction&nbsp;<span className='break-all font-semibold'>{params.get('transactionHash')}</span>&nbsp;was successful!</p>
          </div>
          ):(
            <>
