...
function BookIcon(props: React.ComponentPropsWithoutRef<'svg'>) {
  return (
    <svg viewBox="0 0 16 16" aria-hidden="true" fill="black" {...props}>
...
export function Intro() {
  return (
    <>
      ...
      <h1 className="mt-14 font-display text-4xl/tight font-light text-black">
        Open-source Git client{' '}
        <span className="text-sky-500">for macOS minimalists</span>
      </h1>
