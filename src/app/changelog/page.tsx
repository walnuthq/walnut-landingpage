...
const markdownFiles = [
  { slug: 'calltrace-preview', content: callTracePreviewMD },
  { slug: 'loop-removal-from-call-traces', content: loopRemoval },
];
            ...
            >
              ...
              <div className="sm:col-span-2 sm:max-w-4xl">
                ...
                <div className="mt-6">
                  <ReactMarkdown 
                    components={{
                      h1: ({children}) => <h1 className="font-bold text-2xl mb-4">{children}</h1>,
                      h2: ({children}) => {
                        ...
                        return <h2 className="font-bold my-4 text-xl">{children}</h2>;
                      },
                      p: ({children}) => <p className="text-gray-500 mb-4">{children}</p>,
                      ul: ({children}) => <ul className="list-disc text-gray-500 pl-6 mb-4">{children}</ul>,
