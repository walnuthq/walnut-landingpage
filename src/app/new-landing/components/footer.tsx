  ...
  return (
    <div className="relative pb-16 pt-20 text-center sm:py-24">
      <hgroup>
        ...
        <h2 className="mt-6 text-3xl/[0.9] font-medium tracking-tight text-gray-950 sm:text-5xl">
...
function SocialLinks() {
  return (
    <div className='flex gap-x-1'>
      <IconLink href="https://x.com/walnut_dev" target="_blank" icon={XIcon} className="text-black">
      </IconLink>
      <IconLink href="https://github.com/walnuthq" target="_blank" icon={GitHubIcon} className="text-black">
        </IconLink>
      <IconLink href="https://t.me/walnuthq" target="_blank" icon={TelegramIcon} className="text-black">
      </IconLink>
    </div>
  )
}
