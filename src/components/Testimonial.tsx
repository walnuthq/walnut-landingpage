...
import MartinTriay from '@/images/MartinTriay.jpg'
					...
					<figure className="grid grid-cols-1 items-center gap-x-6 gap-y-8 lg:gap-x-10">
						<div className="relative col-span-2 lg:col-start-1 lg:row-start-2">
							...
							<div className="w-48 h-8">
								<Image width="192" height="32" src="https://www.openzeppelin.com/hubfs/openzeppelin_logo.svg" alt="" />
							</div>
						...
						<div className="col-end-1 w-16 lg:row-span-4 lg:w-72">
							<Image className="rounded-xl bg-indigo-50 lg:rounded-3xl" src={MartinTriay} alt="" />
						</div>
