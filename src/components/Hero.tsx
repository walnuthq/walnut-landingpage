...
import logoCompound from '@/images/logos/compound.png'
    ...
    <Container className="pb-16 pt-20 text-center lg:pt-32">
      <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
        ...
        <span className="relative whitespace-nowrap text-pink-600">
          ...
          <span className="relative">Debugger</span>
        </span>{' '}
        Starknet Deserves
      </h1>
      ...
      <div className="mt-10 flex justify-center gap-x-6">
        ...
        >
          <svg
            aria-hidden="true"
            className="h-3 w-3 flex-none fill-dark-600 group-active:fill-current"
          >
      ...
      <div className="mt-36 lg:mt-44">
        ...
        >
          {[
            [
              { name: 'Yearn', logo: logoYearn },
              { name: 'JediSwap', logo: logoJediswap },
              { name: 'Compound', logo: logoCompound },
              { name: 'Carmine Finance', logo: logoCarmine },
            ],
            [
              ...
              >
                {group.map((company) => (
                  <li key={company.name} className="flex">
                    <Image src={company.logo} alt={company.name} unoptimized className="h-9 w-auto" />
                  </li>
                ))}
              </ul>
            </li>
